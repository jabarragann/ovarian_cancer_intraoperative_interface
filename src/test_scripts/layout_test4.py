...
# --- show some actors ---
vp.at(0).show(Box().c("red"), resetcam=False)  # type: ignore
vp.at(1).show(Box().c("green"), resetcam=False)  # type: ignore
vp.at(2).show(Box().c("blue"), resetcam=False)  # type: ignore
vp.at(3).show(Box().c("orange"), resetcam=False)  # type: ignore
vp.at(4).show(Box().c("cyan"), resetcam=False)  # type: ignore
vp.at(5).show(Box().c("yellow"), resetcam=False)  # type: ignore
vp.at(6).show(Box().c("purple"), resetcam=False)  # type: ignore
# vp.at(7).clear()
